      ...
      methods: {
        ...
        updateValues(activeEditor, clickedSym) {
          if (this.grammarScope == 'source.gams-lst') return
            ...
            utils.getSymbolAtCursor(activeEditor, _.debounce(this.updateVue, 1000, {
              leading: true
            }))
          } else {
            // save state
        ...
        updateConsole(symbol) {
          ...
          if (global.gamsUpdating && global.gamsUpdating.a) {
            ...
            this.consolePanel.log(`No data available for ${symbol.name}. Check for compilation errors and program flow.`)
          } else {
            // create elements
