...
export default {
  config: {
    ...
    'Max. Errors to Display': {
      'description': 'The maximum amount of errors that will be highlighted by linter-gams. Leave blank if no maximum should be defined. Keep in mind that often only the first error is an actual GAMS error, while the subsequent errors may result from the first error.',
      'type': 'integer',
      'default': 1,
      'order': 3
    },
